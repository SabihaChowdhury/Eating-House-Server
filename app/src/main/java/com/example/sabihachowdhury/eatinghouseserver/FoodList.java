...
import com.example.sabihachowdhury.eatinghouseserver.Model.Category;
import com.example.sabihachowdhury.eatinghouseserver.Model.Food;
import com.example.sabihachowdhury.eatinghouseserver.ViewHolder.FoodViewHolder;
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(newFood != null)
                {
                    ...
                    Snackbar.make(rootLayout,"Food "+item.getName()+" is edited",Snackbar.LENGTH_SHORT).show();
                }
            }
        });
        alertDialog.setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
